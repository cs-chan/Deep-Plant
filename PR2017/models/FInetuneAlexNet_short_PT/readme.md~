...
* Please download the training set [here](http://web.fsktm.um.edu.my/~cschan/source/PR2017/Model.zip), located at the folder 'train_patch_com_constrain'.

* Image label can be downloaded [here](http://web.fsktm.um.edu.my/~cschan/source/PR2017/train_label_new_constrain_patch).
